...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DLz5aGiz.mjs");
...
var manifest = {
	"28d9a41ba979249265dc9b70e4cd1858f0fa764906c54f5ecc12f1482ab09b14": {
		functionName: "getRunFn_createServerFn_handler",
		importer: () => import("./run-functions-CXn30WOj.mjs")
	},
	"d748faf6a7dfce2c993afa8e5398f9302a6d468c7d20ae0f5c92a2dc884ef011": {
		functionName: "listRunsFn_createServerFn_handler",
		importer: () => import("./run-functions-CXn30WOj.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-iXolBtOb.mjs").then((n) => n.t),
